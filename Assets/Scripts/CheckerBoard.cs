...
public class CheckerBoard : MonoBehaviour
{
    ...
    public void DropPiece(Piece piece, Vector3 position)
    {
        ...
        if (IsValid(x, z))
        {
            ...
            // Check if there in not an old piece
            if (oldPiece == null)
            {
                // Place piece
            ...
            else // Or if there is an oldPiece occupying that slot
            {
                // Swap the pieces
